...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			'top_bar_background_color' => 'rgba(0,0,0,0)',
			...
			'site_title_color' => '#eeeeee',
			'site_tagline_color' => '#ffffff',
			'navigation_background_color' => 'rgba(0,0,0,0)',
			...
			'fixed_side_content_background_color' => '#eeeeee',
			'fixed_side_content_text_color' => '#222222',
			'fixed_side_content_link_color' => '#222222',
			'fixed_side_content_link_hover_color' => '#000000',
			...
			'blog_header_title_color' => '#eeeeee',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#222222',
			'blog_header_button_bg' => '#eeeeee',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => 'rgba(0,0,0,0)',
			'sidebar_widget_text_color' => '#ffffff',
			'sidebar_widget_link_color' => '#eeeeee',
			'sidebar_widget_link_hover_color' => '#ffffff',
			'sidebar_widget_title_color' => '#eeeeee',
			'footer_widget_background_color' => 'rgba(0,0,0,0)',
			'footer_widget_text_color' => '#ffffff',
			'footer_widget_link_color' => '#eeeeee',
			'footer_widget_link_hover_color' => '#ffffff',
			'footer_widget_title_color' => '#eeeeee',
			'footer_background_color' => 'rgba(0,0,0,0)',
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_blog_header_title' => 'Poppins',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Poppins:300,regular,500,600,700' );
